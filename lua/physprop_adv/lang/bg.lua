return function(sTool) local tSet = {} -- Bulgarian
  ...
  tSet["tool."..sTool..".material_type_con" ] = "Свойства тип:"
  tSet["tool."..sTool..".material_type_def" ] = "Изберете тип..."
  tSet["tool."..sTool..".material_name"     ] = "Изберете име на материала от изброените в списъка"
  tSet["tool."..sTool..".material_name_con" ] = "Свойства име:"
  tSet["tool."..sTool..".material_name_def" ] = "Изберете име..."
